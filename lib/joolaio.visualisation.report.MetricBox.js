...
joolaio.visualisation.report.MetricBox.prototype.update = function (sender, metric, series) {
  ...
  if ((displayValue > 1000000 || displayValue < -1000000) && ((metric.suffix && metric.suffix != 'seconds') || !metric.suffix)) {
...
joolaio.visualisation.report.MetricBox.prototype.draw = function (Container) {
  ...
  if (joolaio.visualisation.report.timeline && joolaio.visualisation.report.timeline.secondaryMetric != null) {
