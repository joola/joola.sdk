...
jarvis.visualisation.report.SummaryTable = function (options) {
    ...
    //jarvis.debug.log('INFO', 'jarvis.visualisation.report.SummaryTable', 5, '...Constructor (' + executionTime + 'ms)');
};
...
jarvis.visualisation.report.SummaryTable.prototype.update = function (sender, dimensions, metrics, series, container) {
    ...
    $(series[0].Rows).each(function (index, row) {
        ...
        var $_bar = $('<div class="barwrapper"><span class="barvalue">' + jarvis.string.formatNumber(v, 2) + '%</span><div class="percentagebar" style="width:' + width + '"></div>' +
 ...
 */
//new jarvis.visualisation.report.SummaryTable().init();
