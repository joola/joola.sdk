...
//                    console.log(filter);
            ...
            $tr.find('.dimensionvalue .drilldownlink').on('click', function (e) {
                ...
                //console.log('Global Filter', jarvis.visualisation.report.globalfilter);
            ...
            if (_this.mode == 'pie') {
                ...
                /*var $_bar = $('<table class="barwrapper">' +
                 ...
                 '<td class="percentagecaption"><div >' + jarvis.string.formatNumber(row.Values[valIndex], 2) + '%</div></td>' +
                 '</tr>' +
                 '</table>');
                 */
...
/*
 ...
 jarvis.visualisation.report.TableEx.init();
 */