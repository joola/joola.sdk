 ...
 */
joolaio.joolaioPath = '';//http://edge.joolaioanalytics.com/joolaio';//http://109.64.28.168/Jarvis/';
...
/**
 * A function to import a single script. This is meant to be overridden when Jarvis is being run in non-HTML contexts, such as web workers. It's defined in the global scope so that it can be set before joolaio.js is loaded, which allows deps to be imported properly.
 */
...
if (!COMPILED) {
    ...
    joolaio.findBasePath_ = function () {
        ...
        for (var i = scripts.length - 1; i >= 0; --i) {
            ...
            if (src.indexOf('jarvis.js')>-1||src.indexOf('jarvis.min.js')>-1) {
