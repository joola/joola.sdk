...
jarvis.visualisation.picker.Metrics = function (options) {
    ...
    //jarvis.debug.log('INFO', 'Jarvis.Visualisation.Picker.Metrics', 5, '...Constructor (' + executionTime + 'ms)');
};
/**
...
jarvis.visualisation.picker.Metrics.prototype.init = function (sender) {
    ...
    var executionTime = new Date().getMilliseconds() - start;
    //jarvis.debug.log('INFO', 'Jarvis.Visualisation.Picker.Metrics', 5, '...init (' + executionTime + 'ms)');
};
