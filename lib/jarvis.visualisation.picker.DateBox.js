        ...
        onSelect: function (dateText, inst) {
            ...
            switch (_this.currentMode) {
                case 'base-from':
                    ...
                    /*
                    var mindateplusone = new Date(_this.min_date);

                    mindateplusone.setDate(mindateplusone.getDate()+1);
                    mindateplusone.setHours(0);
                    mindateplusone.setMinutes(0);
                    mindateplusone.setSeconds(0);

                    mindateplusone.setTime(1364335200000);
                    console.log(mindateplusone.getTime());
                    console.log(_this.base_fromdate.getTime());
                    */
                    if (_this.base_fromdate.getTime() == _this.min_date.getTime()) {
