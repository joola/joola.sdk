...
joolaio.visualisation.report.Panel.prototype.init = function (options, container, drawWidgets, breakBindLoop, saveState) {
  ...
  if (options && options.disableMetrics != null)
    _this.options.widgets.timeline.disableMetrics = options.disableMetrics;
...
joolaio.visualisation.report.Panel.prototype.drawWidgets = function (sender, container, redraw) {
  ...
  if (this.tabType == 'explorer') {
    ...
    joolaio.visualisation.report.timeline = new joolaio.visualisation.report.Timeline().init({primaryMetric: metrics[0].id, height: _this.options.widgets.timeline.height, excludeMetrics: _this.options.widgets.timeline.excludeMetrics, disableMetrics: _this.options.widgets.timeline.disableMetrics, showPrimary: _this.options.widgets.timeline.showPrimary});
